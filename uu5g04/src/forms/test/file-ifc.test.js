...
describe("UU5.Forms.File interface testing", () => {
  it("addValue(value, setStateCallBack)", () => {
    const wrapper = shallow(<UU5.Forms.File label="Upload file" id={"uuID"} />, { disableLifecycleMethods: true });
...
describe("UU5.Forms.InputMixin interface testing", () => {
  ...
  it("getValue() should return value", () => {
    const wrapper = shallow(
      <UU5.Forms.File label="Upload file" id={"uuID"} value={{ name: "/etc/networks/interfaces" }} />,
  ...
  it("setFeedBack(feedback, message, value, setStateCallBack)", () => {
    ...
    const returnValue = wrapper
      .instance()
      .setFeedback("success", "This is valid message.", [{ name: "/etc/networks/interfaces" }], mockFunc);
    wrapper.update();
    expect(mockFunc).toBeCalled();
    expect(mockFunc).toHaveBeenCalledTimes(1);
    expect(returnValue).toBe(wrapper.instance());
  ...
  it("setInitial(msg, value, setStateCallBack)", () => {
    ...
    const returnValue = wrapper
      .instance()
      .setInitial("Initial Message", [{ name: "/etc/networks/interfaces/initial" }], mockFunc);
    wrapper.update();
    expect(mockFunc).toBeCalled();
    expect(mockFunc).toHaveBeenCalledTimes(1);
    expect(returnValue).toBe(wrapper.instance());
    ...
    expect(wrapper.instance().getValue()).toEqual(
      expect.arrayContaining([{ name: "/etc/networks/interfaces/initial" }])
    );
  ...
  it("isInitial()", () => {
    const wrapper = shallow(<UU5.Forms.File id={"id1"} label="File label" />, { disableLifecycleMethods: true });
    const mockFunc = jest.fn();
    expect(wrapper.instance().isInitial()).toBeTruthy();
    expect(wrapper).toMatchSnapshot();
  ...
  it("setLoading(message, value, setStateCallBack)", () => {
    const wrapper = shallow(<UU5.Forms.File id={"id1"} label="Full name" />, { disableLifecycleMethods: true });
    const mockFunc = jest.fn();
    expect(wrapper).toMatchSnapshot();
    expect(wrapper.instance().getValue()).toBe(null);
    expect(wrapper.instance().getMessage()).toBeNull();
    ...
    const returnValue = wrapper
      .instance()
      .setLoading("Loading messsagess", [{ name: "/etc/networks/interfaces" }], mockFunc);
    wrapper.update();
    expect(mockFunc).toBeCalled();
    expect(mockFunc).toHaveBeenCalledTimes(1);
    expect(returnValue).toBe(wrapper.instance());
  ...
  it("setSuccess(message, value, setStateCallBack)", () => {
    const wrapper = shallow(<UU5.Forms.File id={"id1"} label="File" />, { disableLifecycleMethods: true });
    const mockFunc = jest.fn();
    expect(wrapper.instance().getFeedback()).toEqual("initial");
    expect(wrapper.instance().getMessage()).toBe(null);
    expect(wrapper.instance().getValue()).toBe(null);
    ...
    const returnValue = wrapper
      .instance()
      .setSuccess("This is success message", [{ name: "/etc/networks/interfaces" }], mockFunc);
    wrapper.update();
    expect(mockFunc).toBeCalled();
    expect(mockFunc).toHaveBeenCalledTimes(1);
    expect(returnValue).toBe(wrapper.instance());
  ...
  it("setWarning(message, value, setStateCallBack)", () => {
    ...
    const returnValue = wrapper
      .instance()
      .setWarning("This is warning message", [{ name: "/etc/networks/interfaces/warning" }], mockFunc);
    wrapper.update();
    expect(mockFunc).toBeCalled();
    expect(mockFunc).toHaveBeenCalledTimes(1);
    expect(returnValue).toBe(wrapper.instance());
    ...
    expect(wrapper.instance().getValue()).toEqual(
      expect.arrayContaining([{ name: "/etc/networks/interfaces/warning" }])
    );
  ...
  it("isWarning()", () => {
    const wrapper = shallow(
      <UU5.Forms.File id={"id1"} label="File label" feedback={"warning"} message={"Warning message"} required={true} />,
      { disableLifecycleMethods: true }
    );
    const mockFunc = jest.fn();
    expect(wrapper.instance().getFeedback()).toEqual("warning");
    ...
    expect(wrapper.instance().isWarning()).toBeTruthy();
    expect(wrapper).toMatchSnapshot();
    const setRetVal = wrapper
      .instance()
      .setFeedback("success", "success message", [{ name: "/etc/networks/interfaces" }], mockFunc);
    wrapper.update();
    expect(mockFunc).toBeCalled();
  ...
  it("setError(message, value, setStateCallBack)", () => {
    ...
    const returnValue = wrapper
      .instance()
      .setError("This is error mesage", [{ name: "/etc/networks/interfaces/error" }], mockFunc);
    wrapper.update();
    expect(mockFunc).toBeCalled();
    expect(mockFunc).toHaveBeenCalledTimes(1);
    expect(returnValue).toBe(wrapper.instance());
  ...
  it("isError()", () => {
    const wrapper = shallow(
      <UU5.Forms.File id={"id1"} label="File label" feedback={"error"} message={"Error message"} required={true} />,
      { disableLifecycleMethods: true }
    );
    const mockFunc = jest.fn();
    expect(wrapper.instance().getFeedback()).toEqual("error");
  ...
  it("setEditableValue(true, setStateCallback)", () => {
    const wrapper = shallow(
      <UU5.Forms.File id={"id1"} label="File name" value={{ name: "/etc/networks/interfaces" }} required={true} />,
      { disableLifecycleMethods: true }
    );
    const mockFunc = jest.fn();
    expect(wrapper).toMatchSnapshot();
  ...
  it("setEditableValue(false, setStateCallback)", () => {
    const wrapper = shallow(
      <UU5.Forms.File id={"id1"} label="Filename" value={{ name: "/etc/networks/interfaces" }} required={true} />,
      { disableLifecycleMethods: true }
    );
    const mockFunc = jest.fn();
    expect(wrapper).toMatchSnapshot();
