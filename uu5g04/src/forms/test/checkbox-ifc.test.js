...
describe("UU5.Forms.InputMixin interface testing", () => {
  it("isInput()", () => {
    const wrapper = shallow(<UU5.Forms.Checkbox id={"idCheckBox"} label="Option 1" />);
    expect(wrapper.instance().isInput()).toBeTruthy();
    expect(wrapper).toMatchSnapshot();
  });

  it("getValue() should return value", () => {
    const wrapper = shallow(<UU5.Forms.Checkbox id={"idCheckBox"} label="Option 1" value={true} />);
    expect(wrapper.instance().getValue()).toBeTruthy();
    expect(wrapper).toMatchSnapshot();
  });

  it("getValue() should return null", () => {
    const wrapper = shallow(<UU5.Forms.Checkbox id={"idCheckBox"} label="Option 1" value={false} />);
  ...
  it("isSuccess() fisr return false, second return true", () => {
    const wrapper = shallow(<UU5.Forms.Checkbox id={"idCheckBox"} label="Option 1" required={true} value={false} />);
    const mockFunc = jest.fn();
  ...
  it("setWarning(message, value, setStateCallBack)", () => {
    const wrapper = shallow(<UU5.Forms.Checkbox id={"idCheckBox"} label="Option 1" required={false} value={false} />);
    const mockFunc = jest.fn();
    expect(wrapper.instance().getFeedback()).toMatch(/initial/);
    expect(wrapper.instance().getMessage()).toBe(null);
    expect(wrapper.instance().getValue()).toBeFalsy();
  ...
  it("isReadOnly()", () => {
    const wrapper = shallow(<UU5.Forms.Checkbox id={"idCheckBox"} label="Option 1" required={true} value={true} />);
    const mockFunc = jest.fn();
    expect(wrapper.instance().isReadOnly()).toBeFalsy();
    expect(wrapper).toMatchSnapshot();
