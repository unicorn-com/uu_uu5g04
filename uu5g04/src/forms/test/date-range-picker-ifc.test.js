...
describe("UU5.Form.DateRangePicker intreface testing", () => {
  it("parseDate(date)", () => {
    const wrapper = shallow(<UU5.Forms.DateRangePicker label="Date of birth" disableBackdrop id={"uuID01"} />);
  ...
  it("toggle(setStateCallBack, e)", () => {
    const wrapper = mount(<UU5.Forms.DateRangePicker label="Date of birth" disableBackdrop id={"uuID01"} />);
...
describe("UU5.Forms.InputMixin interface testing", () => {
  it("isInput()", () => {
    const wrapper = shallow(
      <UU5.Forms.DateRangePicker id={"idText"} label="Valid time" placeholder="Enter time" required={false} />
    );
  ...
  it("getMessage()", () => {
    const wrapper = shallow(
      <UU5.Forms.DateRangePicker id={"idText"} label="Enter valid time" placeholder="Valid time" required={false} />
    );
  ...
  it("isSuccess() fisr return false, second return true", () => {
    const wrapper = shallow(
      <UU5.Forms.DateRangePicker id={"idText"} label="Enter valid time" placeholder="Valid time" required={true} />
    );
    const mockFunc = jest.fn();
  ...
  it("setError(message, value, setStateCallBack)", () => {
    const wrapper = shallow(<UU5.Forms.DateRangePicker id={"idText"} label="Full name" placeholder="John Smith" />);
    const mockFunc = jest.fn();
  ...
  it("getInput()", () => {
    ...
    expect(
      wrapper.instance().getInput() ===
        wrapper.find(".uu5-forms-daterangepicker-main-input").first().instance().findDOMNode()
    ).toBeTruthy();
  });
