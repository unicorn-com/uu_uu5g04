  ...
  render() {
    ...
    return (
      <Form {...this.getMainPropsToPass()} onSave={this.props.onSave} onCancel={this.props.onCancel}>
        {displayedChildren}
        {!!collapsedChildren.length && <UU5.Bricks.Panel bgStyleHeader="underline" iconAlign="after" iconCollapsed={"mdi-menu-down"} iconExpanded={"mdi-menu-up"} header="Doplňující vlastnosti" className={this.getClassName("additionalPropsPanel")}>
          {collapsedChildren}
        </UU5.Bricks.Panel>}
