...
export const HomeScreen = UU5.Common.VisualComponent.create({
  ...
  _isCompatibleEnvironment: function () {
    return (
      (UU5.Common.Tools.isSafari() && UU5.Common.Tools.getMobileOSVersion() >= 6) || UU5.Common.Tools.isAndroidChrome()
    );
  },
