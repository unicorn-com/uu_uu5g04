...
export const Page = UU5.Common.VisualComponent.create({
  ...
  propTypes: {
    ...
    isLeftOpen: UU5.PropTypes.bool,
    isRightOpen: UU5.PropTypes.bool,
    ...
    leftResizable: UU5.PropTypes.oneOfType([UU5.PropTypes.bool, UU5.PropTypes.oneOf(["open", "closed"])]),
    rightResizable: UU5.PropTypes.oneOfType([UU5.PropTypes.bool, UU5.PropTypes.oneOf(["open", "closed"])]),
