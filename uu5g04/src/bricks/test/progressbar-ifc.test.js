...
describe("UU5.Bricks.ProgressBar interface testing", () => {
  it("Should render with shallow", () => {
    const wrapper = shallow(<UU5.Bricks.ProgressBar id={"uuID01"} name={"progressName"} progress={40} />);
    expect(wrapper).toMatchSnapshot();
  });

  it("setProgress(params, setStateCallBack)", () => {
    const wrapper = mount(<UU5.Bricks.ProgressBar id={"uuID01"} name={"progressName"} progress={40} />);
