  ...
  it("examples HTML5 components should render", () => {
    const wrapper = shallow(
      <UU5.Bricks.Container id={"uuID1"}>
        ...
        Paragraph se chová podobně jako UU5.Bricks.P. Pokud je ale UU5.Bricks.Paragraph prázdný, vygeneruje do svého
        obsahu Lorem ipsum
        <br />
        ...
        <br />
        <UU5.Bricks.Del id={"uuID7"}>
          UU5.Bricks.Del - odstraněný text. Standardně se zobrazuje jako přeškrtnutý. Používá se např. při editaci textu
          více uživateli k zviditelnění změn.
        </UU5.Bricks.Del>
        <br />
        ...
        <UU5.Bricks.Samp id={"uuID12"}>
          UU5.Bricks.Samp - označuje vzorový, zejména textový výstup z nějakého programu. Používejte např. pro ukázky
          csv souborů, výstupy z terminálů atp.
        </UU5.Bricks.Samp>
        {/*@@viewOff:0*/}
