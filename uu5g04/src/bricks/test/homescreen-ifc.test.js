...
describe(`UU5.Bricks.HomeScreen interface testing`, () => {
  ...
  it('activate(setStateCallBack)', () => {
    ...
    window.navigator.userAgent = "Mozilla/5.0 (iPhone; CPU iPhone OS 10_0_1 like Mac OS X) AppleWebKit/602.1.50 (KHTML, like Gecko) Version/10.0 Mobile/14A403 Safari/602.1";
    try {
