      ...
      <div className={className} key="errorDetails">
        ...
        >
          {this.props.errorInfo ? (
            <Div className={this.getClassName("errorInfo")} content={this.props.errorInfo} />
          ) : null}
          <div className={this.getClassName("preWrapper")}>
            <UU5.Bricks.Button
              className={this.getClassName("copyButton")}
              content={this.getLsiComponent("copyButton")}
              onClick={() => UU5.Common.Tools.copyToClipboard(JSON.stringify(content, null, 2))}
            />
      ...
      case "smallBox":
        component = (
          <div {...this._getMainAttrs()}>
            ...
            {this.props.moreInfo &&
              this._getMoreInfoContent(this.props.content || this.props.children || this.getDefault().content)}
