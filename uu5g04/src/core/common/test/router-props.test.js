...
let renderButtons = () => (
  <UU5.Bricks.Div>
    ...
    />
    <UU5.Bricks.Button
      onClick={() => UU5.Environment.setRoute(<UU5.About title="About" />, { url: "about" })}
      content="About"
    />
    <UU5.Bricks.Button
...
describe(`UU5.Common.Router Test Tool API test`, () => {
  ...
  it("test 01 - routes props", () => {
    ...
    wrapper.update();
    expect(wrapper.instance().props.routes).toEqual(
      expect.objectContaining({ "": { component: { tag: "Ucl.Parrot.About" }, noHistory: false } })
    );
    expect(wrapper).toMatchSnapshot();
  });
});
...
describe(`UU5.Common.Router props`, () => {
  ...
  it("test 03 - notFoundRoute props", () => {
    ...
    expect(wrapper.instance().props.notFoundRoute).toEqual(expect.objectContaining({ tag: "UU5.Common.NotFoundTag" }));
  ...
  it("test 04 - route props", () => {
    ...
    expect(wrapper.instance().props.route).toEqual(expect.objectContaining({ tag: "UU5.Home" }));
    wrapper.setProps({ route: { tag: "UU5.About" } });
    wrapper.update();
    expect(wrapper.instance().props.route).toEqual(expect.objectContaining({ tag: "UU5.About" }));
    expect(wrapper).toMatchSnapshot();
  });
  ...
  it("test 05 - routes props", () => {
    ...
    expect(wrapper.instance().props.routes).toEqual(
      expect.objectContaining({ "": { component: { tag: "Ucl.Parrot.Home" }, noHistory: true } })
    );
    expect(wrapper).toMatchSnapshot();
    wrapper.setProps({ routes: { "": { component: { tag: "Ucl.Parrot.About" }, noHistory: false } } });
    wrapper.update();
...
describe(`UU5.Common.Router Common.BaseMixin props`, () => {
  ...
  it("test 05 - style props", () => {
    ...
    wrapper.update();
    expect(wrapper.instance().props.style).toEqual(expect.objectContaining({ fontSize: "20px", color: "red" }));
    expect(wrapper).toMatchSnapshot();
  });
