...
describe('UU5.Common.Url - test interface of instance', () => {
  ...
  it('test06 - Url.decodeValue(value)', () => {
    ...
    expect(UU5.Common.Url.decodeValue(mockArray)).toEqual(
...
describe('UU5.Common.Url - test interface of class', () => {
  ...
  it('test04 - useCase', () => {
    const url = new UU5.Common.Url.parse("https://uuos9.plus4u.net/uu-bookkitg01-main/78462435-ed11ec379073476db0aa295ad6c00178/book");
